/**
 * StrategiesSection Component
 * Tax strategies for Senior Professional dashboard
 */

'use client';

import React from 'react';
import { TaxStrategy } from '@/src/types/established-professional';
    ...
    <div className="bg-white rounded-2xl shadow-lg p-6">
      ...
      <div className="space-y-4">
        {strategies.map((strategy) => (
          <div
            key={strategy.id}
            className="p-4 border border-gray-200 rounded-xl hover:border-amber-300 hover:shadow-md transition-all cursor-pointer"
          >
